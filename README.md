...
2. **Posição da peça (Origem):** A coordenada atual da peça no tabuleiro.
...
5.  **Tratamento de Matrizes:** Manipulação de matrizes bidimensionais para representar o tabuleiro e as possibilidades de movimento no espaço 8x8.
...
* **`modelo`**: Contém definições básicas como as cores das peças.
* **`tabuleiro`**: Gerencia a lógica do tabuleiro, posições, casas e validação de movimentos.
* **`pecas`**: Contém a lógica específica de movimento para cada peça do xadrez.
